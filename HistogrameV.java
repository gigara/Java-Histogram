...
public class HistogrameV extends JFrame {

	private JPanel contentPane;
	private JLabel text29;
	private JLabel text39;
	private JLabel text69;
	private JLabel text100;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					HistogrameV frame = new HistogrameV();
	...
	public HistogrameV() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(HistogrameV.class.getResource("/res/New Image.jpg")));
		setTitle("Histograme Verticle");
		...
		lblNewLabel.setBounds(105, 204, 50, 35);
		...
		text29 = new JLabel();
		text29.setVerticalAlignment(SwingConstants.BOTTOM);
		text29.setHorizontalAlignment(SwingConstants.CENTER);
		text29.setBackground(new Color(0, 128, 128));
		text29.setForeground(Color.RED);
		text29.setFont(new Font("Tahoma", Font.BOLD, 17));
		text29.setBounds(105, 48, 28, 164);
		contentPane.add(text29);
		text29.setBorder(BorderFactory.createLineBorder(Color.darkGray));
				
		
		text39 = new JLabel();
		text39.setVerticalAlignment(SwingConstants.BOTTOM);
		...
		text39.setBorder(BorderFactory.createLineBorder(Color.darkGray));
		text39.setBounds(165, 48, 28, 164);
		contentPane.add(text39);
		
		text69 = new JLabel();
		text69.setVerticalAlignment(SwingConstants.BOTTOM);
		...
		text69.setBorder(BorderFactory.createLineBorder(Color.darkGray));
		text69.setBounds(227, 48, 28, 164);
		contentPane.add(text69);
		
		text100 = new JLabel();
		text100.setVerticalAlignment(SwingConstants.BOTTOM);
		...
		text100.setBorder(BorderFactory.createLineBorder(Color.darkGray));
		text100.setBounds(290, 48, 28, 164);
		...
		btn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				ImageIcon icon = new ImageIcon(HistogrameV.class.getResource("/res/q.jpg"));
				...
				//System.out.println(bar29);
				text29.setText("<html>"+bar29+"</html>");
				...
				for(int x=0;x<count39;x++) {
					bar39 += ("*<br/>");
				}text39.setText("<html>"+bar39+"</html>");
				...
				for(int x=0;x<count69;x++) {
					bar69 += ("*<br/>");
				}text69.setText("<html>"+bar69+"</html>");
				...
				for(int x=0;x<count100;x++) {
					bar100 += ("*<br/>");
				}text100.setText("<html>"+bar100+"</html>");
